...
navLinks.forEach(link => {
    link.addEventListener('click', (e) => {
        ...
        // For external links (like resume.html), let the default behavior work
    });
});
...
const animateElements = document.querySelectorAll('.skill-category, .project-card, .timeline-item, .education-card, .about-card');
...
console.log(`
🚀 Welcome to Nikita Pawar's Portfolio!
📧 Contact: nikitapawar2402@gmail.com
💼 LinkedIn: https://linkedin.com/in/nikitapawar24
🐙 GitHub: https://github.com/nikitapawarnp
`);
